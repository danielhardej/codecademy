...
def admin_greet():
  print("Welcome to SkyRoute admin dashboard.")
  for station in vc_metro.keys():
    print(station)
  station_to_add = input("Enter name of closed station: \n")
  if station_to_add in vc_metro.keys():
    stations_under_construction.append(station_to_add)
    print("Stations under construction: " + str(stations_under_construction))
  else:
    print("Oops, that's not a valid station name.")
...
def set_start_and_end(start_point, end_point):
  ...
  if start_point == end_point:
    print("Oops, your start point and end point are the same. Please enter new start and end points...")
    set_start_and_end(start_point, end_point)
  ...
  for start_station in start_stations:
    for end_station in end_stations:
      ...
      if route is not None:
        routes.append(route)
  #print("Num routes: " + str(len(routes)))
  shortest_route = min(routes, key=len)
  return shortest_route

def goodbye():
  print("Thanks for using SkyRoute! Have a great day!")
