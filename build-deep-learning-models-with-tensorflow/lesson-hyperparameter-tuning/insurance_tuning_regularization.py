# Regularization is a set of techniques that prevent the learning process to
# completely fit the model to the training data which can lead to overfitting.
# Dropout is a technique that randomly ignores, or “drops out” a number of outputs
# of a layer by setting them to zeros.
